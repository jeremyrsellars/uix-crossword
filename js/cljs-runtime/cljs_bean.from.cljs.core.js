...
var G__22743 = cljs.core.next(xs);
var G__22744 = cljs.core.next(ys);
xs = G__22743;
ys = G__22744;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__22681 = val;
var G__22682 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__22681,G__22682) : f.call(null, G__22681,G__22682));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__22687 = val__$1;
var G__22689 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__22687,G__22689) : f.call(null, G__22687,G__22689));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__22693 = val__$1;
var G__22694 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__22693,G__22694) : f.call(null, G__22693,G__22694));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__22761 = cljs.core.next(es);
var G__22762 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__22761;
tcoll__$1 = G__22762;
continue;
} else {
...
var G__22764 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));

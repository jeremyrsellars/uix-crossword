...
var G__13149 = devtools.prefs.pref(v);
v = G__13149;
continue;
} else {
return v;
...
}catch (e13112){var _e__12594__auto__ = e13112;
return false;
}})();
...
}catch (e13116){var _e__12594__auto__ = e13116;
return false;
}})();
...
}catch (e13119){var _e__12594__auto__ = e13119;
return false;
}}
}
});
...
var vec__13130 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13130,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13130,(1),null);
...
return cljs.core.some((function (p1__13137_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13137_SHARP_);
}),template);
});

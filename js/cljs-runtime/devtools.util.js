...
args__5732__auto__.push((arguments[i__5727__auto___14471]));
...
var _STAR_print_newline_STAR__orig_val__14402_14473 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__14403_14474 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__14404_14475 = true;
var _STAR_print_fn_STAR__temp_val__14405_14476 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__14404_14475);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__14405_14476);

try{var _STAR_print_level_STAR__orig_val__14406_14478 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14407_14479 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14407_14479);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14406_14478);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__14403_14474);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__14402_14473);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq14398){
...
var new_formatters = current_formatters.filter((function (p1__14437_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__14437_SHARP_)));
}));
...
var G__14440_14494 = f;
var target__12588__auto___14495 = G__14440_14494;
if(cljs.core.truth_(target__12588__auto___14495)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14440_14494)].join(''),"\n","target__12588__auto__"].join('')));
}

(target__12588__auto___14495["toString"] = (function (){
...
var G__14442_14497 = "%c%s";
var G__14443_14498 = "color:transparent";
var G__14444_14499 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__14442_14497,G__14443_14498,G__14444_14499) : f.call(null, G__14442_14497,G__14443_14498,G__14444_14499));
...
var args__5732__auto__ = [];
var len__5726__auto___14506 = arguments.length;
var i__5727__auto___14507 = (0);
while(true){
if((i__5727__auto___14507 < len__5726__auto___14506)){
args__5732__auto__.push((arguments[i__5727__auto___14507]));

var G__14509 = (i__5727__auto___14507 + (1));
i__5727__auto___14507 = G__14509;
continue;
} else {
}
break;
...
var vec__14450 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14450,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14450,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14510__delegate = function (add_fmt,add_args){
...
var G__14510 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__14511__i = 0, G__14511__a = new Array(arguments.length -  1);
while (G__14511__i < G__14511__a.length) {G__14511__a[G__14511__i] = arguments[G__14511__i + 1]; ++G__14511__i;}
  add_args = new cljs.core.IndexedSeq(G__14511__a,0,null);
} 
return G__14510__delegate.call(this,add_fmt,add_args);};
G__14510.cljs$lang$maxFixedArity = 1;
G__14510.cljs$lang$applyTo = (function (arglist__14513){
var add_fmt = cljs.core.first(arglist__14513);
var add_args = cljs.core.rest(arglist__14513);
return G__14510__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq14446){
...
var G__14449 = cljs.core.first(seq14446__$2);
var seq14446__$3 = cljs.core.next(seq14446__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14447,G__14448,G__14449,seq14446__$3);
}));
...
var seq__14460 = cljs.core.seq(features);
var chunk__14461 = null;
var count__14462 = (0);
var i__14463 = (0);
while(true){
if((i__14463 < count__14462)){
var feature = chunk__14461.cljs$core$IIndexed$_nth$arity$2(null, i__14463);
...
var G__14525 = seq__14460;
var G__14526 = chunk__14461;
var G__14527 = count__14462;
var G__14528 = (i__14463 + (1));
seq__14460 = G__14525;
chunk__14461 = G__14526;
count__14462 = G__14527;
i__14463 = G__14528;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__14460);
if(temp__5804__auto__){
var seq__14460__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__14460__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__14460__$1);
var G__14530 = cljs.core.chunk_rest(seq__14460__$1);
var G__14531 = c__5525__auto__;
var G__14532 = cljs.core.count(c__5525__auto__);
var G__14533 = (0);
seq__14460 = G__14530;
chunk__14461 = G__14531;
count__14462 = G__14532;
i__14463 = G__14533;
continue;
} else {
var feature = cljs.core.first(seq__14460__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null, ).warn(devtools.util.unknown_feature_msg.call(null, feature,known_features,lib_info));
} else {
}
...
var G__14534 = cljs.core.next(seq__14460__$1);
var G__14535 = null;
var G__14536 = (0);
var G__14537 = (0);
seq__14460 = G__14534;
chunk__14461 = G__14535;
count__14462 = G__14536;
i__14463 = G__14537;
continue;
}
} else {
...
var G__14466 = feature;
var G__14466__$1 = (((G__14466 instanceof cljs.core.Keyword))?G__14466.fqn:null);
switch (G__14466__$1) {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14467 = temp__5802__auto__;
return (o14467["version"]);
} else {
return null;
}
})() == null);

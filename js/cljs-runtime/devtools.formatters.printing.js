...
var len__5726__auto___13237 = arguments.length;
var i__5727__auto___13238 = (0);
while(true){
if((i__5727__auto___13238 < len__5726__auto___13237)){
args__5732__auto__.push((arguments[i__5727__auto___13238]));

var G__13239 = (i__5727__auto___13238 + (1));
i__5727__auto___13238 = G__13239;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13163){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13164,G__13165,seq13163__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13172_SHARP_){
return (!((cljs.core.meta(p1__13172_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13202__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13203){var _e__12594__auto__ = e13203;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13208){var _e__12594__auto__ = e13208;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13217 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13218 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13218);
...
var map__13223 = opts;
var map__13223__$1 = cljs.core.__destructure_map(map__13223);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13223__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13217);
}});
...
var temp__5802__auto___13281 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13281)){
var managed_print_level_13282 = temp__5802__auto___13281;
var _STAR_print_level_STAR__orig_val__13233_13283 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13234_13284 = managed_print_level_13282;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13234_13284);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13228_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13228_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13233_13283);
}} else {
job_fn();
}

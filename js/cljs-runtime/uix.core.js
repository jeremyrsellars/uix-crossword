 ...
 */
uix.core.create_class = (function uix$core$create_class(p__24115){
var map__24116 = p__24115;
var map__24116__$1 = cljs.core.__destructure_map(map__24116);
var fields = map__24116__$1;
var contextType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"contextType","contextType",1033066077));
var componentDidUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",-1983477981));
var componentDidCatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"componentDidCatch","componentDidCatch",821717733));
var displayName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601));
var childContextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"childContextTypes","childContextTypes",578717991));
var getSnapshotBeforeUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"getSnapshotBeforeUpdate","getSnapshotBeforeUpdate",861122184));
var contextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"contextTypes","contextTypes",-2023853910));
var getDerivedStateFromProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"getDerivedStateFromProps","getDerivedStateFromProps",-991834739));
var getDerivedStateFromError = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"getDerivedStateFromError","getDerivedStateFromError",166658477));
var componentWillUnmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814));
var shouldComponentUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960));
var render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"render","render",-1408033454));
var defaultProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"defaultProps","defaultProps",-533483149));
var getInitialState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"getInitialState","getInitialState",1541760916));
var constructor$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"constructor","constructor",-1953928811));
var componentDidMount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24116__$1,new cljs.core.Keyword(null,"componentDidMount","componentDidMount",955710936));
...
var G__24117 = props.argv;
if(cljs.core.truth_(props.children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24117,new cljs.core.Keyword(null,"children","children",-940561982),props.children);
} else {
return G__24117;
}
});
...
if((ref.current == null)){
(ref.current = (function (){var x24124 = ({"current": value});
(x24124.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x24124.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x24124.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x24124.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return (this$__$1.current = v);
}));

(x24124.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x24124.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__24125 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__24125) : f.call(null, G__24125));
})());
}));

(x24124.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__24126 = this$__$1.current;
var G__24127 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__24126,G__24127) : f.call(null, G__24126,G__24127));
})());
}));

(x24124.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__24128 = this$__$1.current;
var G__24129 = a;
var G__24130 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__24128,G__24129,G__24130) : f.call(null, G__24128,G__24129,G__24130));
})());
}));

(x24124.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
...
var G__24136 = ({"argv": cljs_bean.core.bean.cljs$core$IFn$_invoke$arity$1(p1__24135_SHARP_)});
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__24136) : f.call(null, G__24136));
});
});
...
if(cljs.core.truth_((function (){var or__5002__auto__ = Array.isArray(coll);
 ...
 */
uix.core.create_error_boundary = (function uix$core$create_error_boundary(p__24137,render_fn){
var map__24138 = p__24137;
var map__24138__$1 = cljs.core.__destructure_map(map__24138);
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24138__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("uix.error-boundary")));
var derive_error_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24138__$1,new cljs.core.Keyword(null,"derive-error-state","derive-error-state",-1373095498));
var did_catch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24138__$1,new cljs.core.Keyword(null,"did-catch","did-catch",2139522313));
...
var G__24139 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state.argv,set_state], null);
var G__24140 = uix.core.glue_args(props);
return (render_fn.cljs$core$IFn$_invoke$arity$2 ? render_fn.cljs$core$IFn$_invoke$arity$2(G__24139,G__24140) : render_fn.call(null, G__24139,G__24140));
});
...
var argv = (function (){var G__24141 = props.argv;
var G__24141__$1 = (cljs.core.truth_(props.children)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24141,new cljs.core.Keyword(null,"children","children",-940561982),props.children):G__24141);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24141__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),ref);

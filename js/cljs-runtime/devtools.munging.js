...
var o12854 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12854["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12855 = temp__5802__auto____$1;
return (o12855["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12571__auto__ = f;
return (o__12571__auto__["toString"]).call(o__12571__auto__);
} else {
return "";
}
...
try{var o__12571__auto___13102 = t;
(o__12571__auto___13102["cljs$lang$ctorPrWriter"]).call(o__12571__auto___13102,t,writer);
}catch (e12861){var __13103 = e12861;
}
...
var char_code = (function (){var o__12571__auto__ = (new String(char$));
return (o__12571__auto__["charCodeAt"]).call(o__12571__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12571__auto__ = String;
return (o__12571__auto__["fromCharCode"]).call(o__12571__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12866 = num_code;
switch (G__12866) {
case (1):
return (185);
...
var o__12571__auto__ = String;
return (o__12571__auto__["fromCharCode"]).call(o__12571__auto__,superscript_code);
});
/**
...
}catch (e12878){var _e__12594__auto__ = e12878;
return false;
}})())){
...
var vec__12887 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(0),null);
...
var len__5726__auto___13125 = arguments.length;
var i__5727__auto___13128 = (0);
while(true){
if((i__5727__auto___13128 < len__5726__auto___13125)){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12902){
var vec__12903 = p__12902;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12903,(0),null);
...
var G__13134 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13135 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13134;
remaining_tokens = G__13135;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12899){
var G__12900 = cljs.core.first(seq12899);
var seq12899__$1 = cljs.core.next(seq12899);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12900,seq12899__$1);
}));
...
var vec__12920 = cljs.core.split_with((function (p1__12918_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12918_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12920,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12920,(1),null);
...
var vec__12933 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12933,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12933,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13140 = cljs.core.rest(remaining_tokens);
var G__13141 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13140;
name_tokens = G__13141;
continue;
} else {
...
var vec__12962 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12962,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12962,(1),null);
var vec__12965 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12965,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12965,(1),null);
var vec__12968 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(3),null);
...
var vec__12980 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12980,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12985 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12985,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12985,(1),null);
var vec__12988 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12988,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12988,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12997 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12997) : devtools.munging.parse_fn_info_deep.call(null, G__12997));
})()));
}
} else {
return fn_info;
...
var G__13152 = (arity + (1));
var G__13153 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13005){
var vec__13006 = p__13005;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13006,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13006,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13036_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13036_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13037_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13037_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___13181 = arguments.length;
var i__5727__auto___13182 = (0);
while(true){
if((i__5727__auto___13182 < len__5726__auto___13181)){
args__5732__auto__.push((arguments[i__5727__auto___13182]));

var G__13183 = (i__5727__auto___13182 + (1));
i__5727__auto___13182 = G__13183;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13042){
var vec__13043 = p__13042;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13043,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13038){
var G__13039 = cljs.core.first(seq13038);
var seq13038__$1 = cljs.core.next(seq13038);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13039,seq13038__$1);
}));
...
var map__13054 = options;
var map__13054__$1 = cljs.core.__destructure_map(map__13054);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13054__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13054__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13054__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13054__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13055 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13055,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13055,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13055,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13055,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13055,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13055,(5),null);
...
var o__12571__auto__ = f;
return (o__12571__auto__["getBasis"]).call(o__12571__auto__);
});
/**
...
}catch (e13058){var _e__12594__auto__ = e13058;
...
var G__13200 = (obj[cljs.core.first(path)]);
var G__13201 = cljs.core.rest(path);
obj = G__13200;
path = G__13201;
continue;
} else {
...
var _STAR_ = (function (accum,p__13064){
var vec__13065 = p__13064;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13065,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13065,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13068){
var vec__13070 = p__13068;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13070,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13070,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13070,(2),null);
...
var post_process = (function (p__13085){
var vec__13086 = p__13085;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13086,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13086,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13080_SHARP_){
return (obj[cljs.core.first(p1__13080_SHARP_)]);
}),sorted_matches);

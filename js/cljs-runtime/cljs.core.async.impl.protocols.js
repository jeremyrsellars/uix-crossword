...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15700 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15700(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15708 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15708(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15716 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15716(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15724 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15724(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15738 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15738(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15739 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15739(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15747 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15747(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15751 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15751(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15756 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15756(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15769 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15769(b);
}
});
